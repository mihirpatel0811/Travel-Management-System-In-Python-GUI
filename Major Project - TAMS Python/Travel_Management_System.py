...
class Travel:
    ...
    def __init__(self, root):
        ...
        self.root.config(bg="#fff")  # Set subtle gray background color
        ...
        def Reset(): 
            ...
            self.txtPlacePrice.configure(state=NORMAL)  # Enable the price entry to clear it
            self.txtPlacePrice.delete(0, END)  # Clear the place price display
            self.txtPlacePrice.configure(state=DISABLED)  # Disable it again
        ...
        def Print():
            ...
            def save_pdf():
                ...
                if filename:
                    pdf_file = os.path.join("D:/Projects/Major Project - TAMS Python/Print Receipt", f"{filename}.pdf")  # Define PDF file path
            ...
            label = Label(ButtonFrame, bd=7, font=('arial', 11, 'bold'), text="File_Name:", bg="#fff", fg="#000")
            ...
            button_save = Button(ButtonFrame, padx=18, bd=7, font=('arial', 15, 'bold'),
                               width=3, text="Save", command=save_pdf, bg="#A9D0F5", fg="#000")
        ...
        def Lug():
            ...
            if var4.get() == 1:
                ...
                Luggage.set("0") # ... (rest of the code remains the same)
        ...
        def FirstClass_Fees():
            """Function to handle First Class ticket fees."""
            global Item7
            if var9.get() == 1:  # If First Class checkbox is checked
                self.txtFirstClass.configure(state=NORMAL)  # Enable the First Class entry
                Item7 = float(3214.95)  # Set the First Class fee
                FirstClass.set("₹ " + str(Item7))  # Update the display with the fee
            elif var9.get() == 0:  # If First Class checkbox is unchecked
                self.txtFirstClass.configure(state=DISABLED)  # Disable the First Class entry
                FirstClass.set("0")  # Reset the display to "0"
        ...
        #=============================================================================================
        CustomerDetailsFrame = Frame(MainFrame, width=1350, height=500, bd=20, pady=5, relief=RIDGE, bg="#fff")
        CustomerDetailsFrame.pack(side=BOTTOM, fill=BOTH, expand=True)  # Fill the available space
        
        FrameDetails = Frame(CustomerDetailsFrame, width=880, height=400, bd=10, relief=RIDGE, bg="#fff")
        ...
        CustomerName = LabelFrame(FrameDetails, width=150, height=250, bd=10, 
                                  font=('arial', 12, 'bold'), text="Customer Details", relief=RIDGE, bg="#E6E6E6", fg="#000")
        CustomerName.grid(row=0, column=0, sticky=NSEW)
        
        TravelFrame = LabelFrame(FrameDetails, width=300, height=250, bd=10, 
                                  font=('arial', 12 , 'bold'), text="Travel Details", relief=RIDGE, bg="#E6E6E6", fg="#000")
        TravelFrame.grid(row=0, column=1, sticky=NSEW)
        
        Ticket_Frame = LabelFrame(FrameDetails, width=300, height=150, relief=FLAT, bg="#E6E6E6", fg="#000")
        Ticket_Frame.grid(row=1, column=0, sticky=NSEW)
        
        CostFrame = LabelFrame(FrameDetails, width=150, height=150, relief=FLAT, bg="#E6E6E6", fg="#000")
        CostFrame.grid(row=1, column=1, sticky=NSEW)
        #=============================================================================================
        Receipt_ButtonFrame = Frame(CustomerDetailsFrame, bd=10, width=450, height=400, relief=RIDGE, bg="#fff")
        Receipt_ButtonFrame.pack(side=RIGHT, fill=BOTH, expand=True)  # Fill the available space
        
        ReceiptFrame = LabelFrame(Receipt_ButtonFrame, width=350, height=300, bg="#E6E6E6", fg="#000",
                                  font=('arial', 12, 'bold'), text="Receipt", relief=RIDGE)
        ReceiptFrame.grid(row=0, column=0, sticky=NSEW)
        
        ButtonFrame = LabelFrame(Receipt_ButtonFrame, width=350, height=100, bd=5, relief=RIDGE, bg="#E6E6E6", fg="#000")
        ButtonFrame.grid(row=1, column=0, sticky=NSEW)
        #=====================================CustomerDetails=========================================
        self.lblFirstname = Label(CustomerName, font=('arial', 14, 'bold'), text="First Name", bd=7, bg="#E6E6E6", fg="#000")
        ...
        #---------------------------------------------------------------------------------------------
        self.lblSurname = Label(CustomerName, font=('arial', 14, 'bold'), text="Surname", bd=7, bg="#E6E6E6", fg="#000")
        ...
        #---------------------------------------------------------------------------------------------
        self.lblAddress = Label(CustomerName, font=('arial', 14, 'bold'), text="Address", bd=7, bg="#E6E6E6", fg="#000")
        ...
        #---------------------------------------------------------------------------------------------
        self.lblPostCode = Label(CustomerName, font=('arial', 14, 'bold'), text="Post Code", bd=7, bg="#E6E6E6", fg="#000")
        ...
        #---------------------------------------------------------------------------------------------
        self.lblMobile1 = Label(CustomerName, font=('arial', 14, 'bold'), text="Mobile 1", bd=7, bg="#E6E6E6", fg="#000")
        ...
        #---------------------------------------------------------------------------------------------
        self.lblMobile2 = Label(CustomerName, font=('arial', 14, 'bold'), text="Mobile 2", bd=7, bg="#E6E6E6", fg="#000")
        ...
        #--------------------------------------------------------------------------------------------
        self.lblEmail = Label(CustomerName, font=('arial', 14, 'bold'), text="Email", bd=7, bg="#E6E6E6", fg="#000")
        ...
        # Package Options
        self.lblPackage = Label(TravelFrame, font=('arial', 14, 'bold'), text="Choose Package", bd=7, bg="#E6E6E6", fg="#000")
        ...
        # Place Options
        self.lblPlace = Label(TravelFrame, font=('arial', 14, 'bold'), text="Choose Place", bd=7, bg="#E6E6E6", fg="#000")
        ...
        # Accommodation
        self.lblAccommodation = Label(TravelFrame, font=('arial', 14, 'bold'), text="Accommodation", bd=7, bg="#E6E6E6", fg="#000")
        ...
        # Select Persons
        self.lblPerson = Label(TravelFrame, font=('arial', 14, 'bold'), text="How Many Persons", bd=7, bg="#E6E6E6", fg="#000")
        ...
        # Place Price Display
        self.lblPlacePrice = Label(TravelFrame, font=('arial', 14, 'bold'), text="Place Price", bd=7, bg="#E6E6E6", fg="#000")
        self.lblPlacePrice.grid(row=4, column=0, sticky=W)
        self.txtPlacePrice = Entry(TravelFrame, font=('arial', 14, 'bold'), bd=7, state=DISABLED, justify=RIGHT)
        self.txtPlacePrice.grid(row=4, column=1)

        #=============================================================================================
        # Checkbox for Ral Tax
        self.chkRalTax = Checkbutton(TravelFrame, text="Ral Tax", variable=var1, onvalue=1, offvalue=0, bg="#E6E6E6", fg="#000",
        ...
        self.chkTravelling_Insurance = Checkbutton(TravelFrame, text="Travelling Insurance", variable=var3, onvalue=1, offvalue=0, bg="#E6E6E6", fg="#000",
        ...
        self.chkExt_Luggage = Checkbutton(TravelFrame, text="Ext. Luggage", variable=var4, onvalue=1, offvalue=0, bg="#E6E6E6", fg="#000",
        ...
        #===================================Payment Information=======================================
        self.lblPaidTax = Label(CostFrame,font=('arial', 14, 'bold'), text="\tPaid Tax", bd=7, bg="#E6E6E6", fg="#000")
        ...
        self.lblSubTotal = Label(CostFrame, font=('arial', 14, 'bold'), text="\tSub Total", bd=7, bg="#E6E6E6", fg="#000")
        ...
        self.lblTotalCost = Label(CostFrame, font=('arial', 14, 'bold'), text="\tTotal Cost", bd=7, bg="#E6E6E6", fg="#000")
        ...
        #=============================================================================================
        self.chkStandard = Checkbutton(Ticket_Frame, text="Standard", variable=var5, bg="#E6E6E6", fg="#000",
                                       onvalue=1, offvalue=0, font=('arial', 14, 'bold'), command=Standard_Fees).grid(row=0, column=0)
        ...
        self.chkSingle = Checkbutton(Ticket_Frame, text="Single", variable=var6, onvalue=1, bg="#E6E6E6", fg="#000",
                                     offvalue=0, font=('arial', 14, 'bold')).grid(row=0, column=2, sticky=W)
        
        self.chkEconomy = Checkbutton(Ticket_Frame, text="Economy", variable=var7, onvalue=1, bg="#E6E6E6", fg="#000",
                                      offvalue=0, font=('arial', 14, 'bold'), command=Economy_Fees).grid(row=1, column=0, sticky=W)
        ...
        self.chkReturn = Checkbutton(Ticket_Frame, text="Return", variable=var8, onvalue=1, bg="#E6E6E6", fg="#000",
                                     offvalue=0, font=('arial', 14, 'bold')).grid(row=1, column=2, sticky=W)
        
        self.chkFirstClass = Checkbutton(Ticket_Frame, text="First Class", variable=var9, onvalue=1, bg="#E6E6E6", fg="#000",
                                          offvalue=0, font=('arial', 14, 'bold'), command=FirstClass_Fees).grid(row=2, column=0)
        ...
        self.chkSpecialNeeds = Checkbutton(Ticket_Frame, text="Special Needs", variable=var10, onvalue=1, bg="#E6E6E6", fg="#000",
                                           offvalue=0, font=('arial', 14, 'bold')).grid(row=2, column=2, sticky=W)
        #=====================================Receipt===================================================
        self.txtReceipt = Text(ReceiptFrame, width=65, height=20, font=('arial', 10, 'bold'), bg="#fff", fg="#000")
